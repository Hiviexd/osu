...
{
    [TestFixture]
    public class CheckTaikoInconsistentOmitFirstBarLineTest
    {
        private CheckTaikoInconsistentOmitFirstBarLine check = null!;

        [SetUp]
        public void Setup()
        {
            check = new CheckTaikoInconsistentOmitFirstBarLine();
        }
        ...
        public void TestInconsistentOmitFirstBarLine()
        {
            ...
            Assert.That(issues.All(issue => issue.Template is CheckTaikoInconsistentOmitFirstBarLine.IssueTemplateInconsistentOmitFirstBarLine));
        ...
        public void TestPartiallyInconsistentOmitFirstBarLine()
        {
            ...
            Assert.That(issues[0].Template is CheckTaikoInconsistentOmitFirstBarLine.IssueTemplateInconsistentOmitFirstBarLine);
